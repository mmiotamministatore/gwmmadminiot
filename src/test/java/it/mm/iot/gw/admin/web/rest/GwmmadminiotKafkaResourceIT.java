...
import it.mm.iot.gw.admin.IntegrationTest;
import it.mm.iot.gw.admin.config.EmbeddedKafka;
import it.mm.iot.gw.admin.config.KafkaSseConsumer;
import it.mm.iot.gw.admin.config.KafkaSseProducer;
...
@WithMockUser
@EmbeddedKafka
class GwmmadminiotKafkaResourceIT {
...
//        client.post().uri("/api/gwmmadminiot-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
//
...
//        String value = client
//            .get()
//            .uri("/api/gwmmadminiot-kafka/consume")
