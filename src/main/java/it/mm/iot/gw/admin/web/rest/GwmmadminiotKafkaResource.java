...
@RestController
@RequestMapping("/api/gwmmadminiot-kafka")
public class GwmmadminiotKafkaResource {

//    private final Logger log = LoggerFactory.getLogger(GwmmadminiotKafkaResource.class);
//
//    private final MessageChannel output;
//    private Sinks.Many<Message<String>> sink = Sinks.many().unicast().onBackpressureBuffer();
//
//    public GwmmadminiotKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
//        this.output = output;
//    }
//
//    @PostMapping("/publish")
